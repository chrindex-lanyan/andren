...
namespace chrindex::andren::base
{
    ...
    PosixUnnamedSignal::PosixUnnamedSignal(PosixUnnamedSignal && _)
    {
        ...
        memcpy(m_sem,_.m_sem,sizeof(sem_t));
        memset(_.m_sem,0,sizeof(sem_t));
        delete _.m_sem;
        _.m_sem = 0;
    }
    ...
    PosixSignal::PosixSignal() { m_handle = 0; m_type = 0; }

    PosixSignal::~PosixSignal() {}

    PosixSignal::PosixSignal(PosixSignal && _)
    {
        m_handle = _.m_handle;
        m_type = _.m_type;
    ...
    PosixSignal &PosixSignal::operator=(PosixSignal && _)
    {
        return *this;
    }

    void PosixSignal::borrow_by(PosixSigHandle *handle)
    {
        m_handle = handle;
    }
